...
<div class="menu-bar">
    ...
    <ul>
        ...
        <li><a href="classe.jsp">GESTION PERSONNEL CLASSES</a></li>
    ...
    <table>
        ...
        <%
            ...
            try {
                ...
                while (rs.next()) {
                    String id_administration = rs.getString("id_administration");
        ...
        %>
        <tr>
            <td><%= id_administration %></td>
            <td><%= prenom %></td>
            <td><%= nom %></td>
            <td><%= telephone %></td>
            <td><%= email %></td>
            <td>
                <form action="supprimerAdministrateur" method="post" style="display:inline;">
                    <input type="hidden" name="id_administration" value="<%= id_administration %>">
