...
<div class="form-container">
    ...
    <form action="ajoutNote" method="post">
        ...
        <select name="id_matiere" required>
            ...
            %>
            <option value="">Entrer La Matiere</option>
        ...
        <label>Devoir:</label>
        <input type="number" name="devoir" step="0.01" required>

        <label>Examen:</label>
        <input type="number" name="examen" step="0.01" required>
        ...
        <label>Années Scolaire:Exemple 2022-2023</label>
        <input type="text" name="annees_scolaire" required>

        <input type="submit" value="Ajouter Note" class="btn-submit"> <br><br>
        <button type="button" class="btn-submitRetour" style="color: white"><a href="interface_enseignant.jsp">Retour</a></button>
    </form>
</div>
