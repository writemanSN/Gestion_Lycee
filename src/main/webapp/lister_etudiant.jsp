...
<div class="menu">
    <div class="menu-options">
        <button class="btn"><a href="interface_enseignant.jsp">RETOUR</a></button>
    </div>
</div>
...
<div class="client-list">
    <table>
        ...
        <tr>
            ...
            <td><%= nom %></td>
            <td>
                <form action="ajoutNote" method="get" style="display:inline;">
                    <input type="hidden" name="matricule" value="<%= matricule %>">
                    <button type="submit" class="btn-edit">Entrer ces Notes</button>
                </form>
            </td>
        </tr>
        <%
