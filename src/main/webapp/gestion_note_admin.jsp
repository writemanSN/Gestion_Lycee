...
<div class="menu">
    <div class="menu-options">
        <button class="btn" id="add-client"><a href="interface_second.jsp">RETOUR</a></button>
    </div>
</div>
...
<div class="client-list">
    <table>
        ...
        <tr>
            ...
            <td>
                <form action="supprimer_note" method="post" style="display:inline;">
                    <input type="hidden" name="matricule" value="<%= matriculeEtudiant %>">
                    <input type="hidden" name="id_matiere" value="<%= rs.getInt("id_matiere") %>">
                    <input type="hidden" name="semestre" value="<%= semestre %>">
                    <input type="hidden" name="annees_scolaire" value="<%= anneesScolaire %>">
                    <button type="submit" class="btn-delete">Supprimer</button>
                </form><br> <br>
                <form action="GenererBulletinServlet" method="get" style="display:inline;">
                    <input type="hidden" name="matricule" value="<%= matriculeEtudiant %>">
                    <input type="hidden" name="id_matiere" value="<%= rs.getInt("id_matiere") %>">
                    <input type="hidden" name="semestre" value="<%= semestre %>">
                    <input type="hidden" name="annees_scolaire" value="<%= anneesScolaire %>">
                    <button type="submit" class="btn-delete">Imprimer le Bulletin</button>
                </form>
            </td>
